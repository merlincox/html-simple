...
// @TODO tests borrowed from html2text: need redoing

func TestIsPlainText(t *testing.T) {
	Convey("IsPlainText should work", t, func() {
		So(IsPlainText("plain text"), ShouldBeTrue)
		So(IsPlainText("<p>good HTML</p>"), ShouldBeFalse)
		So(IsPlainText("good <p>HTML2</p>"), ShouldBeFalse)
		So(IsPlainText("<p>bad HTML</div>"), ShouldBeFalse)
	})
}
...
func TestHTML2Text(t *testing.T) {
	Convey("HTML2Text should work", t, func() {
		...
		Convey("Links", func() {
			...
			So(HTML2Text(`click <a href="test">here</a>`), ShouldEqual, "click here")
		...
		Convey("Large Entity", func() {
			So(HTML2Text("&abcdefghij;"), ShouldEqual, "&abcdefghij;")
		})

		Convey("Numeric HTML Entities", func() {
			So(HTML2Text("&#39;single quotes&#39; and &#52765;"), ShouldEqual, "'single quotes' and 츝")
		})

		// @TODO improve cleanup of space plus line-breaks in output
